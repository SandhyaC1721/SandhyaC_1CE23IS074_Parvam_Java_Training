...
CREATE TABLE `recharges` (
  ...
  KEY `fk_recharges_members` (`memeber_id`),
  CONSTRAINT `fk_recharges_members` FOREIGN KEY (`memeber_id`) REFERENCES `members` (`memeber_id`),
  CONSTRAINT `recharges_ibfk_1` FOREIGN KEY (`memeber_id`) REFERENCES `members` (`memeber_id`) ON DELETE CASCADE ON UPDATE CASCADE,
